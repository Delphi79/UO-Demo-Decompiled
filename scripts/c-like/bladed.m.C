...
FUNCTION void Q4Y8()
{
  ...
  list Q4DS = list( 0x00, "COL_NAME", 0x02, 0x03, "COL_ACTION" );
...
TRIGGER( targetobj )(obj user, obj usedon)
{
  ...
  loc Q60S = loc( getLocation(usedon) );
  int value;
  obj Q60X;
...
TRIGGER( callback , 0x6E )()
{
  ...
  loc place = loc( getObjVar(this, "logLoc") );
