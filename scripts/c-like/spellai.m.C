...
FUNCTION void Q5UO(obj Q5DM)
{
  ...
  loc there = loc( getLocation(target) );
  ...
  list Q4OC = list( 0x1F4A, 0x03, 0x0A, 0x1F5A, 0x02, 0x1A, 0x1F3E, 0x03, 0x06, 0x1F47, 0x03, 0x0A, 0x1F40, 0x03, 0x06, 0x1F2E, 0x03, 0x02, 0x1F30, 0x03, 0x02, 0x1F34, 0x03, 0x02 );
  list Q4GL = list( 0x1F5F, 0x03, 0x34, 0x1F57, 0x03, 0x1A, 0x1F56, 0x03, 0x1A, 0x1F52, 0x03, 0x10, 0x1F4A, 0x03, 0x0A, 0x1F3E, 0x03, 0x06, 0x1F38, 0x03, 0x04, 0x1F32, 0x03, 0x02 );
  list Q5BK = list( 0x1F61, 0x03, 0x34, 0x1F50, 0x01, 0x10, 0x1F4B, 0x02, 0x0A );
  list Q4U0 = list( 0x1F3D, 0x01, 0x06, 0x1F3B, 0x01, 0x04, 0x1F3C, 0x01, 0x04, 0x1F36, 0x01, 0x04, 0x1F35, 0x01, 0x04 );
  list Q4VN = list( 0x1F49, 0x01, 0x0A, 0x1F31, 0x01, 0x02 );
  list Q4O6 = list( 0x1F58, 0x01, 0x1A );
  string Q47Q = Q559;
  if(Q559 < 0x02)
  {
  ...
  case 0x03:
    ...
    break;
  default:
  /* semicolon added by the decompiler post-processor */
    ;
  }
