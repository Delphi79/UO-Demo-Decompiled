...
TRIGGER( targetobj )(obj user, obj usedon)
{
  ...
  case 0x0F9C:
    ...
    if(Q55M > 0x00)
    {
      Q55N = 0x01;
      Q5UA = getHue(Q5UC);
      list Q4DM = list( 0x1517, "shirts", 0x1539, "pants", 0x153D, "misc" );
  ...
  case 0x1768:
    ...
    if(Q55M > 0x00)
    {
      Q55N = 0x01;
      Q5UA = getHue(Q5UC);
      list cloth = list( 0x1517, "shirts", 0x1539, "pants", 0x153D, "misc", 0x0F95, "bolt of cloth" );
  ...
  case 0x1079:
    ...
    {
      Q55N = 0x00;
      list leather = list( 0x1710, "footwear", 0x13CC, "leather armor", 0x13DB, "studded armor", 0x1C02, "female armor" );
...
TRIGGER( typeselected , 0x11 )(obj user, int listindex, int objtype, int objhue)
{
  switch(listindex)
  {
  case 0x01:
    list shirts = list( 0x1517, "Shirt - takes 8 cloth.", 0x1515, "Cloak - takes 14 cloth.", 0x1EFD, "Fancy shirt - takes 8 cloth.", 0x1EFF, "Fancy dress - takes 12 cloth.", 0x1F01, "Plain dress - takes 10 cloth.", 0x1F03, "Robe - takes 16 cloth." );
    selectType(Q62D, this, 0x13, "What kind of shirt?", shirts);
    break;
  case 0x02:
    list pants = list( 0x1539, "Fancy pants - takes 8 cloth.", 0x1537, "Kilt - takes 8 cloth.", 0x1516, "Skirt - takes 10 cloth." );
    selectType(Q62D, this, 0x14, "What kind of pants?", pants);
    break;
  case 0x03:
    list misc = list( 0x1544, "Skullcap - takes 2 cloth.", 0x1540, "Bandana - takes 2 cloth.", 0x1541, "Body sash - takes 4 cloth.", 0x153B, "Half apron - takes 6 cloth.", 0x153D, "Full apron - takes 10 cloth." );
    selectType(Q62D, this, 0x15, "What do you want to make?", misc);
    break;
  case 0x04:
    list bolt = list( 0x0F95, "Bolt of cloth - takes 50 cloth.", 0x0F96, "Bolt of cloth - takes 50 cloth.", 0x0F97, "Bolt of cloth - takes 50 cloth." );
...
TRIGGER( typeselected , 0x13 )(obj user, int listindex, int objtype, int objhue)
{
  Q5C5 = objtype;
  switch(objtype)
  {
...
TRIGGER( typeselected , 0x14 )(obj user, int listindex, int objtype, int objhue)
{
  Q5C5 = objtype;
  switch(objtype)
  {
...
TRIGGER( typeselected , 0x15 )(obj user, int listindex, int objtype, int objhue)
{
  Q5C5 = objtype;
  switch(objtype)
  {
...
TRIGGER( typeselected , 0x3B )(obj user, int listindex, int objtype, int objhue)
{
  Q5C5 = objtype;
  switch(objtype)
  {
...
TRIGGER( typeselected , 0x12 )(obj user, int listindex, int objtype, int objhue)
{
  switch(listindex)
  {
  case 0x01:
    list Q5SU = list( 0x170B, "Boots - take 8 leather.", 0x170D, "Sandals - take 4 leather.", 0x1710, "Shoes - take 6 leather.", 0x1712, "Thigh boots - take 10 leather." );
    selectType(Q62D, this, 0x26, "What kind of shoes?", Q5SU);
    break;
  case 0x02:
    list Q52K = list( 0x13C7, "Leather gorget - takes 4 leather.", 0x13C6, "Leather gloves - takes 6 leather.", 0x13C5, "Leather sleeves - takes 8 leather.", 0x13CB, "Leather leggings - takes 10 leather.", 0x13CC, "Leather tunic - takes 12 leather." );
    selectType(Q62D, this, 0x16, "What kind of leather armor?", Q52K);
    break;
  case 0x03:
    list Q5XD = list( 0x13D6, "Studded gorget - takes 6 leather.", 0x13D5, "Studded gloves - takes 8 leather.", 0x13D4, "Studded sleeves - takes 10 leather.", 0x13DA, "Studded leggings - takes 12 leather.", 0x13DB, "Studded tunic - takes 14 leather." );
    selectType(Q62D, this, 0x17, "What kind of studded armor?", Q5XD);
    break;
  case 0x04:
    list Q4P0 = list( 0x1C00, "Shorts - take 4 leather.", 0x1C02, "One piece - takes 10 leather.", 0x1C06, "One Piece - takes 8 leather.", 0x1C08, "Skirt - takes 6 leather.", 0x1C0A, "Top - takes 4 leather.", 0x1C0C, "Top - takes 4 leather." );
...
TRIGGER( typeselected , 0x26 )(obj user, int listindex, int objtype, int objhue)
{
  Q5C5 = objtype;
  switch(objtype)
  {
...
TRIGGER( typeselected , 0x16 )(obj user, int listindex, int objtype, int objhue)
{
  Q5C5 = objtype;
  switch(objtype)
  {
...
TRIGGER( typeselected , 0x17 )(obj user, int listindex, int objtype, int objhue)
{
  Q5C5 = objtype;
  switch(objtype)
  {
...
TRIGGER( typeselected , 0x2A )(obj user, int listindex, int objtype, int objhue)
{
  Q5C5 = objtype;
  switch(objtype)
  {
...
FUNCTION void Q4ER()
{
  ...
  loc location = loc( getLocation(Q62D) );
