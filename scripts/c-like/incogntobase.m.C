...
FUNCTION int Q4KA(obj user, obj usedon)
{
  ...
  if(Q49Z(usedon))
  {
    ...
    {
      list Q4UU = list( 0x2046, 0x203B, 0x203C, 0x203D, 0x2044, 0x2045, 0x2047, 0x2048, 0x2049, 0x204A );
      Q4UT = Q4UU[Q4UT];
    }
    if(Q4UT)
    {
    ...
    if(Q4RA == 0x01)
    {
      list Q4OR = list( 0x00, 0x2040, 0x203E, 0x203F, 0x2041, 0x204B, 0x204C, 0x204D );
