...
FUNCTION void Q4SF(int Q65M)
{
  ...
  default:
  case 0x00:
    Q48N = list( "  Greetings!", "  I am a poor healer who", "seeks a worthy escort. I", "can offer some small pay", "to any doughty warrior", "able to assist me. It is", "imperative that I reach my", "destination, or innocents", "may perish!" );
    break;
  case 0x01:
    Q48N = list( "  'Tis a terrible thing", "to be a parent with an", "ungrateful child! Yet such", "is my situation.", "  Because of the poor", "behavior and lack of", "character of this offspring", "of mine, I am obliged to", "foster them away from", "home.", "  So now I am in need of", "an able escort of good", "character who might serve", "as role model, and who can", "ensure that my child", "reaches their destination", "safely.", "  I shall let my child", "post their whereabouts so", "that thou mayst meet with", "them and arrange terms." + "           ---" );
    break;
  case 0x02:
    Q48N = list( "  I am so happy! I am to", "be married, and my life", "will finally be complete!", "  Alas, I am no warrior,", "and the wedding is not to", "take place here. I am in", "need of an escort, for the", "roads are treacherous and", "my future spouse would be", "sad indeed to hear that", "an ettin ate me before the", "wedding." );
    break;
  case 0x03:
    Q48N = list( "  Wizard seeks escort to a", "conference." );
    break;
  case 0x04:
    Q48N = list( "  Reputable merchant seeks", "able warriors to serve as", "mercantile escort. Pay is", "scale; we prefer to hire", "experienced mercenaries." );
    break;
  case 0x05:
    Q48N = list( "  I am one of Lord British's", "couriers, and I seek an able", "warrior to escort me safely,", "as the message I carry is of", "utmost importance to the", "realm!" );
    break;
  case 0x06:
    Q48N = list( "  'Tis a bit of a problem to", "admit it, but our normally", "trustworthy household guard", "seem to have broken his leg!", "  If thou art able with a", "weapon, we are pleased to take", "applications for his", "replacement, to serve as", "guard and escort on our", "forthcoming journey." );
    break;
  case 0x07:
    Q48N = list( "  I've always wished for", "adventure! Now I can have it", "at last!", "  My weaponsmaster in school", "always said I was a dab hand", "with a blade, and I am afire", "with the love of adventure!", "  Plus I have money.", "  So if you are willing to", "hire on as my bodyguard and", "join me as we seek the deepest", "depths of the Abyss, and", "as we conquer dragons with", "the rapid flick of our sharp", "swords, disregarding all", "danger and ignorant of fear,", "seek me out!", "  Cowards need not apply!" );
    break;
  }
  return;
}
...
FUNCTION void Q5JV(obj this)
{
  ...
  string Q496;
  string Q636;
  list Q5JR = list( "Escort needed", "Guard needed", "I need an escort!", "Traveling companion?", "Seeking companion", "Now hiring", "Hiring a guard", "Hiring an escort", "Seeking escort" );
  Q636 = Q5JR[random(0x00, numInList(Q5JR) - 0x01)];
  list postText = list( Q636 );
  Q4SF(Q65M);
  list Q5Y7 = list( "  I can be found", getDistance(getLocation(Q48I), getLocation(this)), getDirection(getLocation(Q48I), getLocation(this)) + "", "of here. When thou dost find", "me, look at me close to accept", "the task of taking me to", Q4RI(Q4O8) + ".", "    " + getName(this) );
  string blah;
...
{
  list Q5JT = list( "city_bucden", "city_jhelom", "city_serphold", "city_nujelm", "city_trinsic", "city_skara", "city_ocllo", "city_magincia", "city_moonglow", "city_britain", "city_cove", "city_vesper", "city_minoc", "city_yew" );
...
TRIGGER( 100 , enterrange , 0x01 )(obj target)
{
...
TRIGGER( speech , "I will take thee" )(obj speaker, string arg)
{
