...
FUNCTION void Q4SL(list Q5LQ, int Q5UT)
{
  ...
  {
  case 0x00:
    Q5LQ = list( 0x0F7B, 0x0F88 );
    break;
  case 0x01:
    Q5LQ = list( 0x0F84, 0x0F85, 0x0F86 );
    break;
  case 0x02:
    Q5LQ = list( 0x0F85, 0x0F88 );
    break;
  case 0x03:
    Q5LQ = list( 0x0F84, 0x0F85, 0x0F8D );
    break;
  case 0x04:
    Q5LQ = list( 0x0F7A, 0x0F88 );
    break;
  case 0x05:
    Q5LQ = list( 0x0F8D, 0x0F8C );
    break;
  case 0x06:
    Q5LQ = list( 0x0F84, 0x0F8C, 0x0F8D );
    break;
  case 0x07:
    Q5LQ = list( 0x0F84, 0x0F88 );
    break;
  case 0x08:
    Q5LQ = list( 0x0F7B, 0x0F86 );
    break;
  case 0x09:
    Q5LQ = list( 0x0F86, 0x0F88 );
    break;
  case 0x0A:
    Q5LQ = list( 0x0F84, 0x0F85 );
    break;
  case 0x0B:
    Q5LQ = list( 0x0F88, 0x0F8D );
    break;
  case 0x0C:
    Q5LQ = list( 0x0F84, 0x0F8C, 0x0F8D );
    break;
  case 0x0D:
    Q5LQ = list( 0x0F7B, 0x0F8C );
    break;
  case 0x0E:
    Q5LQ = list( 0x0F84, 0x0F85, 0x0F8C );
    break;
  case 0x0F:
    Q5LQ = list( 0x0F86, 0x0F88 );
    break;
  case 0x10:
    Q5LQ = list( 0x0F84, 0x0F86 );
    break;
  case 0x11:
    Q5LQ = list( 0x0F7A, 0x0F8C );
    break;
  case 0x12:
    Q5LQ = list( 0x0F8C, 0x0F7B, 0x0F84 );
    break;
  case 0x13:
    Q5LQ = list( 0x0F88 );
    break;
  ...
  case 0x16:
    ...
    break;
  case 0x17:
    Q5LQ = list( 0x0F7B, 0x0F84 );
    break;
  case 0x18:
    Q5LQ = list( 0x0F84, 0x0F85, 0x0F86 );
    break;
  case 0x19:
    Q5LQ = list( 0x0F84, 0x0F85, 0x0F86, 0x0F8C );
    break;
  case 0x1A:
    Q5LQ = list( 0x0F84, 0x0F88, 0x0F8C );
    break;
  case 0x1B:
    Q5LQ = list( 0x0F7A, 0x0F8D, 0x0F8C );
    break;
  case 0x1C:
    Q5LQ = list( 0x0F84, 0x0F85, 0x0F86, 0x0F8D );
    break;
  case 0x1D:
    Q5LQ = list( 0x0F7A, 0x0F86, 0x0F8C );
    break;
  case 0x1E:
    Q5LQ = list( 0x0F7A, 0x0F86, 0x0F8D );
    break;
  case 0x1F:
    Q5LQ = list( 0x0F7A, 0x0F7B, 0x0F86 );
    break;
  case 0x20:
    Q5LQ = list( 0x0F7A, 0x0F86, 0x0F88 );
    break;
  case 0x21:
    Q5LQ = list( 0x0F84, 0x0F7A, 0x0F8D, 0x0F8C );
    break;
  case 0x22:
    Q5LQ = list( 0x0F7B, 0x0F84, 0x0F88 );
    break;
  case 0x23:
    Q5LQ = list( 0x0F84, 0x0F86, 0x0F8D );
    break;
  case 0x24:
    Q5LQ = list( 0x0F7A, 0x0F86, 0x0F88, 0x0F8C );
    break;
  case 0x25:
    Q5LQ = list( 0x0F84, 0x0F86, 0x0F8D );
    break;
  case 0x26:
    Q5LQ = list( 0x0F7A, 0x0F88, 0x0F8D );
    break;
  case 0x27:
    Q5LQ = list( 0x0F7B, 0x0F86, 0x0F8D );
    break;
  case 0x28:
    Q5LQ = list( 0x0F84, 0x0F86, 0x0F8C );
    break;
  case 0x29:
    Q5LQ = list( 0x0F7A, 0x0F88 );
    break;
  ...
  case 0x2C:
    ...
    break;
  case 0x2D:
    Q5LQ = list( 0x0F84, 0x0F86, 0x0F88, 0x0F8C );
    break;
  case 0x2E:
    Q5LQ = list( 0x0F7A, 0x0F85, 0x0F8D );
    break;
  case 0x2F:
    Q5LQ = list( 0x0F7B, 0x0F8C );
    break;
  case 0x30:
    Q5LQ = list( 0x0F7A, 0x0F7B, 0x0F86, 0x0F8C );
    break;
  case 0x31:
    Q5LQ = list( 0x0F7A, 0x0F86, 0x0F8D, 0x0F8C );
    break;
  case 0x32:
    Q5LQ = list( 0x0F8D, 0x0F8C );
    break;
  case 0x33:
    ...
    break;
  case 0x34:
    Q5LQ = list( 0x0F86, 0x0F7A, 0x0F7B, 0x0F8D );
    break;
  case 0x35:
    Q5LQ = list( 0x0F7A, 0x0F84, 0x0F86, 0x0F8C );
    break;
  case 0x36:
    Q5LQ = list( 0x0F7B, 0x0F8D, 0x0F86, 0x0F8C );
    break;
  case 0x37:
    Q5LQ = list( 0x0F7B, 0x0F86, 0x0F8D );
    break;
  case 0x38:
    Q5LQ = list( 0x0F7B, 0x0F85, 0x0F86, 0x0F8C );
    break;
  case 0x39:
    Q5LQ = list( 0x0F7A, 0x0F7B, 0x0F86, 0x0F88 );
    break;
  case 0x3A:
    Q5LQ = list( 0x0F7B, 0x0F84, 0x0F85 );
    break;
  case 0x3B:
    Q5LQ = list( 0x0F7B, 0x0F86, 0x0F8D );
    break;
  case 0x3C:
    Q5LQ = list( 0x0F7B, 0x0F86, 0x0F8D, 0x0F8C );
    break;
  case 0x3D:
    Q5LQ = list( 0x0F7B, 0x0F86, 0x0F8D );
    break;
...
FUNCTION int Q43E(obj Q5U8, obj target, int damage)
{
  ...
  if(target != NULL())
  {
    loc Q639 = loc( getLocation(target) );
...
FUNCTION int Q41L(obj Q4P2, obj target)
{
  ...
  int Q5NC = 0x00;
  loc Q4P3 = loc( getLocation(Q4P2) );
  int Q6A1 = getZ(Q4P3);
  loc Q5YV = loc( getLocation(target) );
  int Q6A3 = getZ(Q5YV);
  int Q4HE = 0x08;
  if(Q6A3 >= Q6A1)
  {
