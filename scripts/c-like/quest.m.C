...
FUNCTION void Q5VQ(obj Q5KS)
{
  ...
  list Q5LW = list( "I have a deep hatred for ", "I have a feud with ", "I was insulted terribly by ", "I have good reasons to wish someone dead... ", "'Tis distasteful, perhaps, but with such a scoundrel, there is no other solution. 'Tis ", "Revile me not, but I have an enemy: ", "I have an enemy, ", "I have reasons to wish someone dead... Their name is ", "I was asked to kill someone but I am too scared to do it. Their name is ", "My family hath had a longstanding feud with " );
  string Q59W = Q5LW[random(0x00, numInList(Q5LW) - 0x01)];
...
FUNCTION void Q5VM(obj Q5KS)
{
  ...
  list Q5LW = list( "A friend of mine needeth ", "I promised to take something to a friend... ", "I am supposed to deliver " );
  string Q59W = Q5LW[random(0x00, numInList(Q5LW) - 0x01)];
