...
FUNCTION string Q4RP(obj this)
{
  ...
  if(reward == NULL())
  {
    Q4D4 = list( "Alas, I have naught to offer thee in payment save rumors.", "Sadly, all I can offer thee in return is rumors.", "Rumors and news are all I can offer in payment.", "I have no reward to give thee, though.", "I have nothing to offer thee as a reward save rumors.", "I wish that I had aught to entice thee with, but all I can offer is rumors.", "Sadly, rumors and news are all I have to give thee in return." );
    Q5N7 = Q4D4[random(0x00, numInList(Q4D4) - 0x01)];
    return(Q5N7);
  }
  Q4D4 = list( "I can pay thee.", "I can reward thee.", "I have some small payment to offer.", "I have some small reward to give.", "I can give thee a reward.", "I can give thee some payment.", "I can offer thee a small reward.", "I can offer thee some small payment." );
  Q5N7 = Q4D4[random(0x00, numInList(Q4D4) - 0x01)];
  Q4D4 = list( " As reward, I have ", " I can give thee ", " I would give thee ", " I could give thee ", " I might give thee ", " As reward, mayhap I have ", " Mayhap I can give thee ", " Mayhap I would give thee ", " Mayhap I could give thee " );
  Q5N7 = Q4D4[random(0x00, numInList(Q4D4) - 0x01)];
...
FUNCTION string Q4CO(obj this, list args)
{
  ...
  int Q4QI;
  string name;
  list Q4CV = list( "payment", "reward", "pay", "give" );
  int i;
...
FUNCTION string Q4CP(obj this, list args)
{
  ...
  if(Q4QI)
  {
    Q5N5 = list( "Ah! I shan't give thee ", "Thou canst not have the ", "I will not simply give thee the ", "I shan't just give thee the ", "What? Nay, I will not just give thee ", "Ah! I will not simply hand thee " );
...
TRIGGER( speech , "*" )(obj speaker, string arg)
{
  ...
  if(isInList(args, "quest"))
  {
    ...
    {
      string Q5N5 = list( getObjVar(this, "questIntroMessage") );
      bark(this, Q5N5);
      Q57S(this);
      return(0x00);
    }
...
FUNCTION string Q59D()
{
  ...
  if(random(0x00, 0x01))
  {
    Q5LW = list( ", someone nobody shall miss", ", whom even their mother disliketh", ", well-known as scum", ", a scab upon the face of the earth", ", who clearly deserveth to die", ", who is unworthy of thy blade, perhaps... but worthy of someone's", ". I am not the sort to dirty my hands", ", but I have standing in this town and dare not jeopardize it", "; I fear I cannot do it myself", "; I dare not do it myself", "; suspicion would fall 'pon me were I to do it myself", "; all would suspect me immediately" );
    Q59W = Q5LW[random(0x00, numInList(Q5LW) - 0x01)];
  }
  Q5LW = list( ". I'd like thee to kill them.", ". Thou shouldst kill them for me.", " and I'd like thee to kill them.", " and thou'rt a good choice for the murderer.", ". Thou mightest be a good choice for the murderer.", ". Kill them for me." );
