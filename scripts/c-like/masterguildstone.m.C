...
TRIGGER( message , "sendOtherGuilds" )(obj sender, list args)
{
  list Q4Q1;
...
TRIGGER( message , "IAmHere" )(obj sender, list args)
{
  int i;
  list Q663;
  obj Q55K;
  ...
  if(!Q4QI)
  {
    ...
    int Q65M = args[0x03];
    Q663 = list( guild, name, Q44R, Q65M );
...
TRIGGER( message , "newGuild" )(obj sender, list args)
{
  list Q663;
  obj guild = args[0x00];
  string name = args[0x01];
...
TRIGGER( message , "deadGuild" )(obj sender, list args)
{
  list Q663;
  obj Q4GS = args[0x00];
  int Q4Y2;
...
TRIGGER( message , "requestChangeName" )(obj sender, list args)
{
  ...
  list Q5CZ = list( sender, Q5CU, Q55K );
  removeItem(guilds, Q4Y2);
...
TRIGGER( message , "doesMyGuildExist" )(obj sender, list args)
{
  list Q663;
  obj Q4VT = args[0x00];
  obj m;
...
TRIGGER( message , "requestChangeAbbr" )(obj sender, list args)
{
  ...
  list Q5CZ = list( sender, Q55K, Q5CH, 0x00 );
  removeItem(guilds, Q4Y2);
  appendToList(guilds, Q5CZ);
  Q66E(Q5CZ);
  list Q5DA = list( Q5CH );
