...
{
  loc Q56T = loc( 0x1430, 0x0257, 0x00 );
...
{
  loc Q56T = loc( 0x1435, 0x0257, 0x00 );
...
{
  loc Q56T = loc( 0x1435, 0x0250, 0x04 );
...
{
  loc Q56T = loc( 0x1430, 0x0248, 0x00 );
