...
TRIGGER( callback , 0x62 )()
{
  ...
  {
    loc there = loc( getObjVar(this, "myGuardPost") );
...
TRIGGER( pathnotfound , 0x15 )()
{
  ...
  loc place = loc( getObjVar(this, "myGuardPost") );
...
TRIGGER( enterrange , 0x06 )(obj target)
{
  if(isDead(target))
  {
    return(0x01);
