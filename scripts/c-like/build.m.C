...
TRIGGER( creation )()
{
  ...
  Q542 = 0x00 - 0x7F;
  Q4W0 = 0x7F;
  Q5VR = loc( 0x00, 0x00, 0x00 );
  Q4NU = loc( 0x00, 0x00, 0x00 );
  Q5ZF = list( "None" );
  Q64K = list( "None" );
  return(0x01);
}
...
FUNCTION void Q5IK(loc place)
{
  ...
  string e;
  string Q5H7;
  Q5H7 = loc( "" + getX(place) + " " + getY(place) + " " + getZ(place) );
  int x;
  if(random(0x00, 0x05) > 0x03)
  {
    ...
    {
    case 0x00:
      s = list( "newtree", "underbrush", "newlog", "newrock" );
    ...
    case 0x01:
      ...
      s = list( 0x0D25, 0x0D26, 0x0D27, 0x0D28, 0x0D2A, 0x0D2C, 0x0D2E, 0x0D25, 0x0D26, 0x0D27, 0x0D28, 0x0D2A, 0x0D2C, 0x0D2E, 0x0D25, 0x0D26, 0x0D27, 0x0D28, 0x0D2A, 0x0D2C, 0x1363, 0x1364, 0x1365, 0x1366, 0x1367, 0x1368, 0x1369, 0x136A, 0x136B, 0x136C, 0x136D, 0x0D2E, 0x0D32, 0x0D32, 0x0D32, 0x0C95, 0x0C96, 0x0D31, 0x0D30, 0x0D35, 0x0D37 );
      ...
      break;
    case 0x02:
      s = list( "newjtree", "newjbrush", "newjbrush", "newjbrush", "newjlog", "newrock", "newjshroom" );
      e = s[random(0x00, numInList(s) - 0x01)];
      escript(gm, e, Q5H7);
      break;
    case 0x03:
      ...
      s = list( 0x0CAF, 0x0CB0, 0x0CB5, 0x0CB6, 0x0C85, 0x0D29, 0x0D2B, 0x0D2D, 0x0D2F, 0x0D15, 0x0D16, 0x0D17, 0x0D18, 0x0D19, 0x0D15, 0x0D16, 0x0D17, 0x0D18, 0x0D19, 0x0D14, 0x0D13, 0x0D12, 0x1773, 0x1774, 0x177B, 0x177C, 0x1777, 0x1778, 0x1363, 0x1364, 0x1365, 0x1366, 0x1367, 0x1368, 0x1369, 0x136A, 0x136B, 0x136C, 0x136D );
      x = s[random(0x00, numInList(s) - 0x01)];
      createStatic(place, x);
      break;
    case 0x04:
      ...
      break;
    case 0x05:
      s = list( 0x0D08, 0x0D06, 0x0DC2, 0x0D07, 0x0DC3, 0x0DC1, 0x0D0A, 0x0DBC, 0x0D09, 0x0DBD, 0x0D0B, 0x0DBE, 0x0D04, 0x0CB7, 0x0CB8, 0x0CB9, 0x0CBA, 0x0CBB, 0x0CBC, 0x0CBD, 0x0CB7, 0x0CB8, 0x0CB9, 0x0CBA, 0x0CBB, 0x0CBC, 0x0CBD, 0x0CB7, 0x0CB8, 0x0CB9, 0x0CBA, 0x0CBB, 0x0CBC, 0x0CBD, 0x0CC4, 0x0C94, 0x0C93, 0x0C98, 0x0C97, 0x0CA7 );
      x = s[random(0x00, numInList(s) - 0x01)];
      createStatic(place, x);
      break;
    case 0x06:
      s = list( 0x0D08, 0x0D06, 0x0DC2, 0x0D07, 0x0DC3, 0x0DC1, 0x0D0A, 0x0DBC, 0x0D09, 0x0DBD, 0x0D0B, 0x0DBE, 0x0D04, 0x0D05, 0x324E, 0x3250, 0x324D, 0x324C, 0x0CF8, 0x0CFB, 0x0CFE, 0x0D01 );
      x = s[random(0x00, numInList(s) - 0x01)];
      createStatic(place, x);
      loc Q5DL;
      if(x == 0x324E)
      ...
      break;
    case 0x07:
      s = list( 0x1B7E, 0x1B7E, 0x1B7E, 0x1B7E, 0x1B7E, 0x0CD6, 0x0CD8, 0x0CD6, 0x0CD8, 0x0CD6, 0x0CD8, 0x0CD6, 0x0CD8, 0x0CD6, 0x0CD8, 0x0CD6, 0x0CD8, 0x0CD6, 0x0CD8, 0x0CD6, 0x0CD8, 0x0CD6, 0x0CD8, 0x0CD6, 0x0CD8, 0x0CD6, 0x0CD8, 0x0CD6, 0x0CD8, 0x0CD6, 0x0CD8, 0x0CD6, 0x0CD8, 0x0CD6, 0x0CD8, 0x0CD6, 0x0CD8, 0x0CD6, 0x0CD8, 0x0CD6, 0x0CD8, 0x0CD6, 0x0CD8, 0x0CD6, 0x0CD8, 0x0CD6, 0x0CD8, 0x0CD6, 0x0CD8 );
      if(random(0x00, 0x07))
      {
        x = s[random(0x00, numInList(s) - 0x01)];
        createStatic(place, x);
...
FUNCTION int Q4Z3(loc place)
{
  ...
  loc Q52P = loc( getX(place), getY(place) + 0x01, 0x00 );
  Q52M = getElevation(Q52P);
  loc Q5NU = loc( getX(place) + 0x01, getY(place), 0x00 );
  Q5NS = getElevation(Q5NU);
  loc Q48X = loc( getX(place) + 0x01, getY(place) + 0x01, 0x00 );
...
FUNCTION void Q4M6(loc place)
{
  ...
  int Q48W;
  list t;
  t = list( 0x022C, 0x022D, 0x022E, 0x022F );
  Q63M = getElevation(place);
  loc Q52P = loc( getX(place), getY(place) + 0x01, 0x00 );
  Q52M = getElevation(Q52P);
  loc Q5NU = loc( getX(place) + 0x01, getY(place), 0x00 );
  ...
  if(Q52M > Q5NS)
  {
    t = list( 0x022B, 0x021F, 0x0220, 0x0221, 0x0222, 0x0223, 0x0224, 0x0225, 0x0226 );
    setTile(place, t[random(0x00, numInList(t) - 0x01)]);
    return;
  }
...
FUNCTION void Q4JN(loc place)
{
  ...
  if((Q503(Q66J)) && (!Q503(left)) && (!Q503(Q66I)))
  {
    Q62L = 0x0D;
    c = 0x01;
    Q4FA = loc( getX(place) - 0x01, getY(place) - 0x01, getZ(place) );
  }
  ...
  if((Q503(left)) && (!Q503(right)))
  {
    ...
    c = 0x01;
    Q4FA = loc( getX(place) - 0x01, getY(place), getZ(place) );
  }
  ...
  if((Q503(Q66I)) && (!Q503(lower)))
  {
    ...
    c = 0x01;
    Q4FA = loc( getX(place), getY(place) - 0x01, getZ(place) );
  }
...
TRIGGER( textentry , 0x00 )(obj sender, int button, string text)
{
  if(button == 0x00)
  {
    Q4JL(gm);
...
TRIGGER( typeselected , 0x01 )(obj user, int listindex, int objtype, int objhue)
{
  if(listindex == 0x00)
  {
...
TRIGGER( textentry , 0x02 )(obj sender, int button, string text)
{
  ...
  Q69Y = Q69P;
  Q69Z = Q69R;
  Q5VR = loc( Q69N, Q69Y, 0x00 );
  Q4NU = loc( Q69O, Q69Z, 0x00 );
  Q4JL(gm);
  return(0x00);
}
...
TRIGGER( typeselected , 0x02 )(obj user, int listindex, int objtype, int objhue)
{
  if(listindex == 0x00)
  {
...
TRIGGER( typeselected , 0x03 )(obj user, int listindex, int objtype, int objhue)
{
  if(listindex == 0x00)
  {
    systemMessage(gm, "Terrain fill cancelled.");
