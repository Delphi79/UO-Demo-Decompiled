...
FUNCTION void Q4M1(obj this, obj target, int mod)
{
  ...
  loc Q60S = loc( getLocation(target) );
...
TRIGGER( callback , 0x38 )()
{
  ...
  if(myLoyalty < 0x01)
  {
    ...
    list Q5N8;
    Q5N8 = list( "'Twas nice speaking with thee.", "I suppose I have other things to do.", "Thou seemst to be done speaking with me.", "Unless thou needest aught else, I am done with speaking.", "Unless thou needest aught else, I have my work to do.", "'A pleasure talking with thee.", "Farewell.", "Goodbye.", "Until later.", "Until we meet again.", "'Twas a pleasure.", "Farewell for now.", "Goodbye for now.", "Thou'rt done, and I have work to do.", "I have matters to attend to.", "Fare thee well." );
    if(getIntelligence(this) < 0x22)
    {
      Q5N8 = list( "'Twas nice speakin' with ye.", "I's got other things to do, I reckon.", "Thou seemst to be done speakin' to me.", "'Less'n thou needst aught else, I's done.", "'Less'n thou needst aught else, I's got work to be doing.", "Nice talkin' with thee.", "Farewell.", "Bye!", "'Til later.", "'Til we meet again.", "Farewell for now.", "Goodbye for now.", "Thee's done, and I have work to do.", "I's got things to do.", "Fare thee well." );
    }
    if(0x00)
    {
...
{
  loc Q4VS = loc( getLocation(this) );
  loc there = loc( getLocation(speaker) );
  ...
  {
    loc myJobLocation = loc( getObjVar(this, "myJobLocation") );
...
FUNCTION string Q4TQ(obj this, obj talker)
{
  ...
  string Q60S;
  string Q612;
  Q5N8 = list( "Rumor has it that ", "According to tales, ", "I have heard that ", "Thou didst not hear this from me, but ", "Hast thou heard that ", "Some say that ", "According to some, ", "'Tis bandied about that ", "The word is, ", "The word is that ", "'Tis rumored that ", "'Tis said that ", "Gossip has it that ", "Tongues are wagging! They say that ", "All that rumormongerers can think about is that ", "All I hear of these days is that ", "They are saying that " );
  ...
  clearList(Q5N8);
  Q5N8 = list( "may be about. ", "can be found. ", "might be nearby. ", "could be around. ", "is somewhere close. ", "is nearby. ", "might be found close by. ", "may be somewhere close. " );
  Q496 = Q5N8[random(0x00, (numInList(Q5N8) - 0x01))];
  clearList(Q5N8);
  Q5N8 = list( "Look thee", "Hast thou looked", "Thou mightest look", "Hast thou checked", "I wonder if any have looked", "Possibly", "Perchance 'tis" );
