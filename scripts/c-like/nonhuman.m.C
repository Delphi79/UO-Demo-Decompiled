...
{
  list Q4GU = list( "Revenge!", "NOOooo!", "I... I...", "Me no die!", "Me die!", "Must... not die...", "Oooh, me hurt...", "Me dying?" );
  Q5LC(Q4GU);
  return(0x01);
}
...
{
  list Q58D = list( "Ha! Thou dead!", "Thou not attack me! ", "Die!", "Die! Die!", "There!", "Thou, die!", "Fight me not!", "Ha! Be ghost now!" );
  Q5LC(Q58D);
  return(0x01);
}
...
TRIGGER( 100 , washit )(obj attacker, int damamt)
{
  ...
  if(damamt < 0x01)
  {
    Q58D = list( "Ha! Bad fighter!", "You miss!", "Bad aim!", "Enemy fight bad!", "Me fight better!", "Thou art doomed..." );
    Q5LC(Q58D);
    return(0x01);
  }
  if(damamt < 0x05)
  {
    Q58D = list( "Ouch!", "Me not hurt bad!", "Thou fight bad.", "Thy blows soft!", "You bad with weapon!" );
  }
  else
  {
    Q58D = list( "Ouch! Me hurt!", "No, kill me not!", "Me hurt!", "Away with thee!", "Oof! That hurt!", "Aaah! That hurt...", "Good blow!" );
  }
  Q5LC(Q58D);
  return(0x01);
}