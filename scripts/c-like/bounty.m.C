...
{
  list Q5Y8 = list( "  A bounty is hereby offered", "  Lord British sets a price", "  Claim the reward! 'Tis", "  Lord Blackthorn set a price", "  The Paladins set a price", "  The Merchants set a price", "  Lord British's bounty " );
  string Q5Y4 = Q5Y8[random(0x00, numInList(Q5Y8) - 0x01)];
  return(Q5Y4);
}
...
TRIGGER( speech , "add" )(obj speaker, string arg)
{
  if(0x00)
  {
    Q4J1(speaker, this);
...
TRIGGER( speech , "count" )(obj speaker, string arg)
{
  if(0x00)
  {
    string Q4Q1;
