  ...
  case 0x1EBC:
    ...
    case 0x1BF4:
      ...
      if(testSkill(user, 0x25))
      {
        ...
        list Q574 = list( 0x112D, "Dart Trap", 0x10F8, "Explosion Trap", 0x1148, "Poison Trap", 0x0F9D, 0x1053, 0x105D, 0x1055, 0x10E4, 0x10E5, 0x10E6, 0x10E7, 0x13F6, 0x0F9E, 0x0FBC, 0x1028, 0x1034, 0x102A, 0x13E4, 0x0FB5, 0x0F3A );
    ...
    case 0x1BE2:
      ...
      if(testSkill(user, 0x25))
      {
        ...
        list wood = list( 0x105B, 0x102C, 0x1032, 0x1030, 0x104D );
...
TRIGGER( typeselected , 0x18 )(obj user, int listindex, int objtype, int objhue)
{
  Q5C5 = objtype;
  switch(objtype)
  {
...
TRIGGER( typeselected , 0x19 )(obj user, int listindex, int objtype, int objhue)
{
  Q5C5 = objtype;
  switch(objtype)
  {
