...
TRIGGER( message , "getMyPriceModifier" )(obj sender, list args)
{
  int Q60J = 0x00;
...
TRIGGER( time , "hour:**" )()
{
  ...
  {
    loc place = loc( getObjVar(this, "myJobLocation") );
...
TRIGGER( pathfound , 0x08 )()
{
  ...
  loc there = loc( getLocation(Q5OI) );
...
TRIGGER( leaverange , 0x05 )(obj target)
{
  if(Q50K(this, target))
  {
    Q45D(this, target);
...
TRIGGER( 300 , enterrange , 0x05 )(obj target)
{
  if(!Q50K(this, target))
  {
    return(0x01);
...
TRIGGER( callback , 0x0C )()
{
  if(0x00)
  {
    ...
    loc Q51B = loc( getObjVar(this, "myJobLocation") );
    int x = getX(Q51B);
    int y = getY(Q51B);
    string Q61A = x;
    string Q61B = y;
    string place = loc( "My job location is " + Q61A + ", " + Q61B + "." );
    bark(this, place);
  }
  int Q60B = getHour();
  if(hasObjVar(this, "myJobLocation"))
  {
    loc there = loc( getObjVar(this, "myJobLocation") );
...
FUNCTION int Q4TP(obj this, obj speaker, string arg)
{
  ...
  for(i = Q699; i < numInList(args); i ++)
  {
    ...
    {
      Q5QL = "blackthornkeep";
      Q618 = "Blackthorn's keep"/* replaced == with = */;
      Q4TS = 0x01;
      Q4QI = 0x01;
    }
    ...
    {
      Q5QL = "duelpit";
      Q618 = "dueling pit"/* replaced == with = */;
      Q4QI = 0x01;
    }
    if(Q618 == "farm")
    {
...
TRIGGER( convofunc , "GetNeed" )(obj talker, string arg)
{
  string Q5N7;
...
TRIGGER( convofunc , "Leave" )(obj talker, string arg)
{
...
TRIGGER( convofunc , "Attack" )(obj talker, string arg)
{
...
TRIGGER( convofunc , "getHint" )(obj talker, string arg)
{
...
FUNCTION int Q4M7(obj this, obj speaker, string arg)
{
  ...
  if(hasObjVar(this, "myJobLocation"))
  {
    ...
    if(!Q4QI)
    {
      ...
      if(hasObjVar(this, "myJobLocation"))
      {
        loc Q5SY = loc( getObjVar(this, "myJobLocation") );
...
TRIGGER( sawdeath )(obj attacker, obj victim, obj corpse)
{
  ...
  list Q5OE = list( attacker, victim );
...
TRIGGER( convofunc , "GetItem" )(obj talker, string arg)
{
  string theItemGiven;
