...
FUNCTION int Q62Q(obj Q62O, int Q4DW, int Q478)
{
  ...
  if(((Q4DW >= 0x00) && (Q4DW <= 0x07)) || ((Q4DW >= 0x0B) && (Q4DW <= 0x1A)) || ((Q4DW >= 0x1D) && (Q4DW <= 0x24)))
  {
    ...
    if(Q5NC == 0x00)
    {
      bark(Q62O, "Ar, we've stopped sir.")/* semicolon added by the decompiler post-processor */;
      Q5FV = Q630(Q62O);
      Q62W(Q62O);
      return(0x00);
    }
    else
    {
      if(Q5NC < 0x00)
      {
        bark(Q62O, "Ar, turbulent water!")/* semicolon added by the decompiler post-processor */;
        Q62V(Q62O);
...
TRIGGER( textentry , 0x18 )(obj sender, int button, string text)
{
  if(button == 0x00)
  {
    return(0x00);
