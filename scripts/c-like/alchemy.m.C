...
TRIGGER( typeselected , 0x2B )(obj user, int listindex, int objtype, int objhue)
{
  if(listindex == 0x00)
  {
    return(0x00);
  ...
  clearList(Q5JY);
  Q5JY = list( Q5LR, Q4IB, power, Q5OM );
  Q4FQ = user;
  Q5VP();
  return(0x00);
}
...
TRIGGER( targetobj )(obj user, obj usedon)
{
  ...
  if(Q4R3 < 0x03)
  {
    ...
    {
    case 0x0F7A:
      Q5K3 = list( 0x0F0B, "Refresh", 0x0F0B, "Total Refreshment" );
      Q5JY = list( 0x01, 0x00, 0xFA, "", 0x05, 0x01F4, 0x03E8, "" );
      break;
    case 0x0F7B:
      Q5K3 = list( 0x0F08, "Agility", 0x0F08, "Greater Agility" );
      Q5JY = list( 0x01, 0x0190, 0x0A, "", 0x03, 0x0258, 0x14, "" );
      break;
    case 0x0F8D:
      Q5K3 = list( 0x0F06, "Nightsight" );
      Q5JY = list( 0x01, 0x00, 0x00, "" );
      break;
    case 0x0F85:
      Q5K3 = list( 0x0F0C, "Lesser Heal", 0x0F0C, "Heal", 0x0F0C, "Greater Heal" );
      Q5JY = list( 0x01, 0x00, 0x64, "", 0x03, 0x0190, 0xC8, "", 0x07, 0x0320, 0x012C, "" );
      break;
    case 0x0F86:
      Q5K3 = list( 0x0F09, "Strength", 0x0F09, "Greater Strength" );
      Q5JY = list( 0x02, 0x01F4, 0x0A, "", 0x05, 0x02BC, 0x14, "" );
      break;
    case 0x0F88:
      Q5K3 = list( 0x0F0A, "Lesser Poison", 0x0F0A, "Poison", 0x0F0A, "Greater Poison", 0x0F0A, "Deadly Poison" );
      Q5JY = list( 0x01, 0xC8, 0x01, "", 0x02, 0x0190, 0x02, "", 0x04, 0x0320, 0x03, "", 0x08, 0x047E, 0x04, "" );
      break;
    case 0x0F84:
      Q5K3 = list( 0x0F07, "Lesser Cure", 0x0F07, "Cure", 0x0F07, "Greater Cure" );
      Q5JY = list( 0x01, 0x96, 0x2D, "", 0x03, 0x01F4, 0x4B, "", 0x06, 0x0384, 0x64, "" );
      break;
    case 0x0F8C:
      Q5K3 = list( 0x0F0D, "Lesser Explosion", 0x0F0D, "Explosion", 0x0F0D, "Greater Explosion" );
      Q5JY = list( 0x03, 0x012C, 0x0A, "", 0x05, 0x0258, 0x14, "", 0x0A, 0x0384, 0x28, "" );
      break;
    default:
