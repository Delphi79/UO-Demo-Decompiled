...
{
  Q492 = list( 0x020A, 0x020F, 0x0210, 0x0211, 0x0212, 0x0213, 0x0214, 0x0215, 0x0216, 0x0217, 0x0218, 0x0219, 0x021D, 0x021E, 0x0220, 0x0221, 0x022B, 0x022C, 0x022F, 0x0230, 0x0231, 0x0232, 0x0235, 0x0242, 0x0243, 0x0244 );
  return(0x00);
}
...
TRIGGER( time , "hour:0" )()
{
  if(hasObjVar(this, "beenUsed"))
  {
    removeObjVar(this, "beenUsed")/* semicolon added by the decompiler post-processor */;
  }
  return(0x00);
}
