...
TRIGGER( message , "getPriceModifier" )(obj sender, list args)
{
  int Q60J = 0x64;
...
TRIGGER( enterrange , 0x0A )(obj target)
{
  if(!Q50K(this, target))
  {
    return(0x01);
...
FUNCTION int Q4M7(obj this, obj speaker, string arg)
{
  ...
  int Q4QI;
  Q4QI = 0x00;
  Q51Z = list( "buy", "trade", "commerce", "merchant", "shop", "purchase", "business", "open", "shopkeeper", "trader", "tradesman", "shopkeep" );
  split(Q619, arg);
